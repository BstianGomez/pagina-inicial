...
class ExpenseController extends Controller
{
	public function index()
	{
		...
		return view('expenses.index', compact('reports', 'categories', 'cecos'));
	}
	...
	public function drafts()
	{
		...
		return view('expenses.drafts', compact('expenses'));
	}
	...
	public function edit(Expense $expense)
	{
		...
		return view('expenses.edit', compact('expense', 'categories', 'cecos'));
	}
