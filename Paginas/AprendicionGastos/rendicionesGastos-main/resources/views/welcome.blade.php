        ...
        <div class="relative mx-auto z-10 w-full max-w-2xl ui-system">
            <div class="guest-shell overflow-hidden">
                ...
                <div class="px-8 py-12 sm:px-12 sm:py-14 text-center">
                    <img src="{{ asset('images/logo-sofofa-dark.png') }}" alt="Logo" class="mx-auto h-16 w-auto mb-6">
                    ...
                    <div class="mt-8 flex flex-wrap items-center justify-center gap-3">
                        @auth
                            <a href="{{ route('dashboard') }}" class="btn-premium">Ir al Dashboard</a>
                        @else
                            <a href="{{ route('login') }}" class="btn-premium">Iniciar Sesion</a>
                        @endauth
                    </div>
                </div>
            </div>
