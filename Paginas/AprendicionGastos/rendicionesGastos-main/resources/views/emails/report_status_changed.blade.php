...
| | |
| :--- | :--- |
| <x-mail::button :url="$approveUrl" color="success">APROBAR</x-mail::button> | <x-mail::button :url="$rejectUrl" color="error">RECHAZAR</x-mail::button> |
</x-mail::table>
@else
<x-mail::button :url="config('app.url') . '/informes/' . $report->id">
