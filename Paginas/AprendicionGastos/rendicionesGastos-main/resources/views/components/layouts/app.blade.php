    ...
    <div class="page">
        <aside class="sidebar is-initializing" id="sidebar">
            ...
            <nav class="sidebar-nav">
                ...
                <a href="{{ route('expenses.index') }}" class="nav-item {{ request()->routeIs('expenses.index') ? 'active' : '' }}" title="Gastos">
                    <svg class="nav-icon" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <a href="{{ route('expenses.drafts') }}" class="nav-item {{ request()->routeIs('expenses.drafts') ? 'active' : '' }}" title="Borradores de Gastos">
                    <svg class="nav-icon" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                @hasanyrole('Aprobador|Gestor|Admin|Superadmin')
                    <a href="{{ route('reports.inbox') }}" class="nav-item {{ request()->routeIs('reports.inbox') ? 'active' : '' }}" title="Bandeja">
                        <svg class="nav-icon" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                @hasanyrole('Superadmin|Admin')
                    ...
                    <a href="{{ route('config.index') }}" class="nav-item {{ request()->routeIs('config.*') ? 'active' : '' }}" title="Configuración">
                        <svg class="nav-icon" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <div class="topbar-inner">
                    <div class="brand">
                        <div class="topbar-logo-card">
                            <img src="{{ asset('images/Logos sofofa (1) (1).png') }}" alt="Logo" class="topbar-logo">
                        </div>
