<x-layouts.app
    ...
    <form id="export-form" action="{{ route('reports.export') }}" method="POST">
        @csrf
                ...
                <div class="px-6 pt-7 pb-6 sm:px-8 lg:px-10 border-b border-slate-200/80 bg-gradient-to-b from-white to-slate-50/30">
                    <div class="reports-toolbar">
                        <div class="reports-toolbar-group">
                            ...
                            <a href="{{ route('expenses.create') }}" class="reports-toolbar-btn reports-toolbar-btn-primary">
                        ...
                        <table class="reports-table">
                            ...
                            <tbody>
                                ...
                                @php
                                    ...
                                    $targetUrl = $report->status === \App\Models\Report::STATUS_DRAFT ? route('expenses.createStep1', $report) : route('reports.show', $report);
                                @endphp
