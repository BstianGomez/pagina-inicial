        ...
        <div class="overflow-x-hidden">
            <table class="table-sofofa inbox-table">
                ...
                <tbody class="bg-white">
                    ...
                    @endphp
                    <tr class="{{ $inboxRowClasses }}" onclick="window.location='{{ route('reports.show', $report) }}'">
                        ...
                        <td class="text-center py-4">
                            <a href="{{ route('reports.show', $report) }}" class="inline-flex items-center justify-center px-4 py-1.5 bg-sofofa-blue text-white text-[9px] font-black rounded-lg hover:bg-sofofa-blue-dark transition-all uppercase tracking-widest shadow-sm group-hover:scale-105">
                                Revisar
                            </a>
                        </td>
                    </tr>
