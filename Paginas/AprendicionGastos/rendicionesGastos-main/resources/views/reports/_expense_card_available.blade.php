    ...
    <div class="flex-1 min-w-0">
        <div class="flex items-center gap-2 flex-wrap">
            ...
            @if($expense->status === \App\Models\Expense::STATUS_DRAFT)
                <a href="{{ route('expenses.edit', $expense) }}" onclick="event.stopPropagation();" class="text-[9px] font-bold text-sofofa-blue uppercase tracking-widest hover:underline bg-blue-50 px-2 py-0.5 rounded">Editar</a>
            @else
