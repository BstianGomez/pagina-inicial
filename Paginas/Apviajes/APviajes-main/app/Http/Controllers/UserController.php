...
class UserController extends Controller
{
    ...
    public function update(Request $request, User $user)
    {
        ...
        if ($this->rolActual() === 'admin' && $user->rol === 'super_admin') {
            return redirect('/usuarios')->with('error', 'No tienes permiso para modificar a un Super Administrador.');
        }
    ...
    public function destroy(User $user)
    {
        ...
        if ($this->rolActual() === 'admin' && $user->rol === 'super_admin') {
            return redirect('/usuarios')->with('error', 'No tienes permiso para eliminar a un Super Administrador.');
        }
