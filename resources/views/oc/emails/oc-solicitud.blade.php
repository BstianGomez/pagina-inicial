...
<body>
    <div class="container">
        ...
        <div class="content">
            ...
            @if($tipo === 'created')
                <div class="actions">
                    <a href="{{ route('oc.solicitudes.aceptar-email', $solicitud->id) }}" class="btn btn-accept">
                        ✓ Aceptar
                    </a>
                    <a href="{{ route('oc.solicitudes.rechazar-email', $solicitud->id) }}" class="btn btn-reject">
                        ✗ Rechazar
                    </a>
                </div>
            @endif
