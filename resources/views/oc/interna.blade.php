...
@section('title', 'Solicitud OC Interna')
@section('subtitle', 'Creación de orden de compra administrativa interna')

@section('header')
<div class="ms-banner">
    <div>
        <h1 class="ms-banner-title">Solicitud OC Interna</h1>
        <p class="ms-banner-sub">Cree una nueva orden de compra para uso administrativo interno.</p>
    </div>
</div>
@endsection
...
<form action="{{ route('oc.interna') }}" method="POST" enctype="multipart/form-data">
    @csrf
    ...
    <div class="form-card-premium">
        <div class="card-section-header">
            ...
            <h2 class="card-section-title">Detalles de la Orden</h2>
        </div>
        ...
        <div class="card-body-padding">
            <div class="form-grid-modern">
                ...
                <div class="form-group-modern">
                    ...
                    <input type="text" class="input-premium" name="rut_proveedor" id="rutProveedor" readonly placeholder="Se completa al elegir proveedor">
                </div>
            </div>
            ...
            <div class="form-grid-modern">
                <div class="form-group-modern">
                    <label class="label-modern">Monto (Neto/Bruto) <span class="required-star">*</span></label>
            ...
            <div class="form-group-modern" style="margin-bottom: 1.5rem;">
                <label class="label-modern">Descripción del Gasto <span class="required-star">*</span></label>
                <textarea class="input-premium textarea-premium" name="descripcion" required placeholder="Ej: Compra de insumos de oficina para el mes de Mayo..."></textarea>
            </div>

            <div class="form-group-modern">
                <label class="label-modern">Observaciones Adicionales</label>
                <textarea class="input-premium textarea-premium" name="observacion" placeholder="Cualquier detalle relevante para el aprobador..."></textarea>
            </div>
        </div>
...
<script>
    document.addEventListener('DOMContentLoaded', () => {
        ...
        document.getElementById('btnNextStep1').onclick = () => {
            ...
            if(valid) { step1.style.display = 'none'; step2.style.display = 'block'; footer1.style.display = 'none'; footer2.style.display = 'flex'; }
        };

        document.getElementById('btnPrevStep2').onclick = () => { step2.style.display = 'none'; step1.style.display = 'block'; footer2.style.display = 'none'; footer1.style.display = 'flex'; };
        ...
        document.getElementById('formNuevoProveedor').onsubmit = function(e) {
            ...
            .then(data => {
                if (data.success) {
                    ...
                    Swal.fire({ icon: 'error', title: 'Error', text: data.message || 'No se pudo registrar el proveedor.' });
                }
            })
            .catch(err => {
