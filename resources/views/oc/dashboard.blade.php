                ...
                <div class="table-wrap">
                    <table>
                        ...
                        <tbody>
                                ...
                                <tr style="cursor: pointer; transition: background 0.2s;" onclick="window.location.href='{{ route('oc.gestor') }}';" onmouseover="this.style.background='#f0f4f8'" onmouseout="this.style.background='transparent'">
                                    ...
                                    <td style="text-align: right;">
                                        @if(in_array($row->estado, ['Edicion', 'Ajuste']))
                                            <a href="{{ route('oc.solicitudes.editar', $row->id) }}" class="btn btn-primary" style="padding: 4px 10px; font-size: 11px; background: #f59e0b;">
                            ...
                            @empty
                                <tr>
                                    <td colspan="11">Aun no hay solicitudes registradas.</td>
                                </tr>
                            @endforelse
                        </tbody>
                    </table>
