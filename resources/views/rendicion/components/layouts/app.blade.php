                ...
                <div class="topbar-inner">
                    <div class="brand">
                        <div class="topbar-logo-card">
                            <img src="{{ asset('rendicion_legacy/images/Logos sofofa (1) (1).png') }}" alt="Logo" class="topbar-logo">
                        </div>
                    ...
                    <div class="toolbar-actions">
                        ...
                        @if($showLogout)
                            @auth
                                <form action="{{ route('rendicion.logout') }}" method="POST" style="display: inline-flex; margin: 0; padding: 0; height: 100%;">
                                    @csrf
