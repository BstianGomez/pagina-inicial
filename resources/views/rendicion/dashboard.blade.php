<x-rendicion.layouts.app
    ...
    @if($draftExpensesCount > 0)
        <div class="dash-draft-alert">
            ...
            <div class="dash-draft-alert-actions">
                <a href="{{ route('rendicion.expenses.drafts') }}" class="dash-draft-alert-link">Gestionar Borradores</a>
                <a href="{{ route('rendicion.expenses.create') }}" class="dash-draft-alert-btn">Crear Rendición</a>
            </div>
        </div>
    @endif
    ...
    <div class="dash-quick-grid">
        <a href="{{ route('rendicion.expenses.index') }}" class="dash-quick-card">
        ...
        <a href="{{ route('rendicion.reports.index') }}" class="dash-quick-card">
            <span class="dash-quick-icon">
        ...
        @if(auth()->user()->hasAnyRole(['Gestor', 'Aprobador', 'Admin', 'Superadmin']))
            <a href="{{ route('rendicion.reports.inbox') }}" class="dash-quick-card">
                <span class="dash-quick-icon">
        ...
        <a href="{{ route('rendicion.analytics.index') }}" class="dash-quick-card">
            <span class="dash-quick-icon">
    ...
    @php
        $toggleInProcessUrl = $statusGroup === 'in_process'
            ? route('rendicion.dashboard')
            : route('rendicion.dashboard', ['status_group' => 'in_process']);
        $toggleAcceptedUrl = $statusGroup === 'accepted'
            ? route('rendicion.dashboard')
            : route('rendicion.dashboard', ['status_group' => 'accepted']);
        $toggleRejectedUrl = $statusGroup === 'rejected'
            ? route('rendicion.dashboard')
            : route('rendicion.dashboard', ['status_group' => 'rejected']);
        $toggleReimbursedUrl = $statusGroup === 'reimbursed'
            ? route('rendicion.dashboard')
            : route('rendicion.dashboard', ['status_group' => 'reimbursed']);
    @endphp

    <div class="dash-stats">
        <a href="{{ route('rendicion.dashboard') }}" class="dash-stat dash-stat--requested {{ empty($statusGroup) ? 'is-active' : '' }}">
    ...
    <div class="dash-table-shell">
        <div class="dash-table-head">
            ...
            <a href="{{ route('rendicion.reports.index') }}" class="dash-btn">Ver todo</a>
        </div>
                ...
                <tbody class="bg-white">
                    @forelse($reports as $report)
                        @php
                            ...
                            $route = $isDraft ? route('rendicion.expenses.createStep1', $report->id) : route('rendicion.reports.show', $report->id);
