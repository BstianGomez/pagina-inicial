    ...
    <div class="linking-container pb-20">
        ...
        <div class="bg-slate-50/50 rounded-[2.5rem] p-4 md:p-8">
            <div class="flex items-center justify-between mb-8 px-4">
                ...
                <a href="{{ route('rendicion.expenses.drafts') }}" class="text-[10px] font-bold text-blue-600 hover:text-blue-700 uppercase tracking-widest flex items-center gap-2">
            ...
            @if($availableExpenses->isEmpty())
                <div class="empty-state">
                    ...
                    <div class="flex flex-col sm:flex-row items-center justify-center gap-4 mt-8">
                        <a href="{{ route('rendicion.expenses.drafts') }}" class="inline-flex items-center gap-2 px-8 py-4 bg-blue-600 text-white rounded-2xl text-xs font-black uppercase tracking-widest hover:bg-blue-700 transition-all shadow-lg shadow-blue-500/20">
                            Ir a completar borradores
                        </a>
                        <a href="{{ route('rendicion.reports.show', $report) }}" class="inline-flex items-center gap-2 px-8 py-4 bg-white border-2 border-slate-200 text-slate-600 rounded-2xl text-xs font-black uppercase tracking-widest hover:bg-slate-50 transition-all">
                            Aceptar y Volver
                        </a>
                    </div>
                </div>
            @else
                ...
                <div class="mt-16 text-center">
                    <a href="{{ route('rendicion.reports.show', $report) }}" class="inline-flex items-center gap-3 px-12 py-5 bg-slate-900 text-white rounded-2xl text-xs font-black uppercase tracking-[0.2em] hover:bg-slate-800 transition-all shadow-2xl shadow-slate-200">
