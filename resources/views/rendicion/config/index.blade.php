<x-rendicion.layouts.app
                        ...
                        <tr class="hover:bg-slate-50/80 transition-colors duration-150">
                            ...
                            <td class="text-right">
                                <div class="cfg-row-actions">
                                    ...
                                    <form method="POST" action="{{ route('rendicion.config.category.destroy', $category) }}" class="inline-flex">
                                        @csrf
                                        @method('DELETE')
                        ...
                        <tr class="hover:bg-slate-50/80 transition-colors duration-150">
                            ...
                            <td class="text-right">
                                <div class="cfg-row-actions">
                                    ...
                                    <form method="POST" action="{{ route('rendicion.config.ceco.destroy', $ceco) }}" class="inline-flex">
                                        @csrf
                                        @method('DELETE')
    ...
    <script>
        ...
        function openCategoryModal() {
            ...
            document.getElementById('category-form').action = "{{ route('rendicion.config.category.store') }}";
        ...
        function openCecoModal() {
            ...
            document.getElementById('ceco-form').action = "{{ route('rendicion.config.ceco.store') }}";
