<x-rendicion.layouts.app page_title="Borradores de Gastos" page_subtitle="Gestiona y completa tus gastos antes de rendirlos.">
    <style>
        .draft-container {
            max-width: 1200px;
            margin: 0 auto;
    ...
    <div class="draft-container">
        <div class="draft-header-card">
            ...
            <div class="draft-actions-group">
                <a href="{{ route('rendicion.expenses.index') }}" class="btn-premium btn-premium-outline">
                ...
                <a href="{{ route('rendicion.expenses.create') }}" class="btn-premium btn-premium-primary">
                ...
                <tbody>
                    @forelse($expenses as $expense)
                        <tr>
                            ...
                            <td>
                                @if($expense->status === \App\Models\Rendicion\Expense::STATUS_READY)
                            ...
                            <td style="text-align: center;">
                                <div style="display: flex; justify-content: center; gap: 10px;">
                                    <a href="{{ route('rendicion.expenses.edit', $expense) }}" class="action-btn btn-edit" title="Editar Información">
                                    ...
                                    <form action="{{ route('rendicion.expenses.destroy', $expense) }}" method="POST" onsubmit="return confirm('¿Estás seguro de eliminar este gasto permanentemente?')">
                                        @csrf
                                        @method('DELETE')
                        ...
                        <tr>
                            <td colspan="6">
                                <div class="empty-state">
                                    ...
                                    <a href="{{ route('rendicion.expenses.index') }}" class="btn-premium btn-premium-primary">Empezar a Cargar</a>
                                </div>
                            </td>
                        </tr>
                    @endforelse
