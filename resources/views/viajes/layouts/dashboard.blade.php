    ...
    <aside class="sidebar" id="sidebar">
        <div class="sidebar-header">
            <div class="brand-badge" style="background: white; padding: 4px; display: flex; align-items: center; justify-content: center;">
                <img src="/img/logo.png" alt="Fundación SOFOFA" style="max-width: 100%; max-height: 100%; object-fit: contain;">
            </div>
        ...
        <nav class="sidebar-nav">
            ...
            <a href="{{ route('viajes.mis-solicitudes') }}" class="nav-item @if(request()->is('viajes/mis-solicitudes')) active @endif" title="Mis Solicitudes">
            ...
            <a href="{{ url('viajes/solicitudes') }}" class="nav-item @if(request()->is('viajes/solicitudes')) active @endif" title="Solicitar Viaje">
                <svg class="nav-icon" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <a href="{{ url('viajes/reportes') }}" class="nav-item @if(request()->is('viajes/reportes')) active @endif" title="Estadísticas">
                <svg class="nav-icon" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <a href="{{ route('viajes.aprobador') }}" class="nav-item @if(request()->is('viajes/aprobador')) active @endif" title="Aprobaciones">
                <svg class="nav-icon" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <a href="{{ route('viajes.gestion') }}" class="nav-item @if(request()->is('viajes/gestion')) active @endif" title="Gestión">
                <svg class="nav-icon" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <a href="{{ url('viajes/usuarios') }}" class="nav-item @if(request()->is('viajes/usuarios')) active @endif" title="Usuarios">
                <svg class="nav-icon" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0z"/>
                </svg>
                <span class="nav-label">Usuarios</span>
            </a>
            <a href="{{ url('viajes/usuarios') }}" class="nav-item" title="Crear Usuario">
                <svg class="nav-icon" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div class="topbar-inner">
                ...
                <div class="topbar-center" style="position: absolute; left: 50%; transform: translateX(-50%); text-align: center; pointer-events: none;">
                    <div style="display: flex; align-items: center; gap: 12px; background: rgba(255,255,255,0.12); padding: 8px 26px; border-radius: 50px; border: 1px solid rgba(255,255,255,0.2); backdrop-filter: blur(10px); box-shadow: 0 4px 20px rgba(0,0,0,0.08);">
                        <img src="/img/icon.png" alt="Icon" style="width: 28px; height: 28px; object-fit: contain; filter: brightness(0) invert(1); opacity: 0.95;">
                ...
                <div class="toolbar-actions">
                    ...
                    <!-- Logout -->
                    <form action="{{ route('viajes.logout') }}" method="POST" style="margin:0;">
                        @csrf
