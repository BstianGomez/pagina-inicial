    ...
    <main class="card" role="main" aria-label="Error de autorización">
        ...
        <section class="content">
            ...
            <div class="actions">
                ...
                <a href="{{ request()->is('rendicion*') ? route('rendicion.dashboard') : (request()->is('viajes*') ? url('/viajes') : (request()->is('oc*') ? route('oc.index') : route('app-redirect'))) }}" class="btn btn-primary">Ir al inicio</a>
            </div>
        </section>
    </main>
</body>
