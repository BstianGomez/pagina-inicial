...
use App\Models\Viajes\Gestion;
use App\Models\Viajes\Solicitud;
use App\Models\Viajes\ArchivoSolicitud;
...
class GestionController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('viajes.gestion', compact('pendientesEstimacion', 'pendientesFinalizacion', 'historial'));
    }
